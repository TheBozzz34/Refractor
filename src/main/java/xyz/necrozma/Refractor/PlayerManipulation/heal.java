...
@org.bukkit.plugin.java.annotation.command.Command(name = "heal", desc = "Heals a player", permission = "refractor.heal", permissionMessage = "You do not have permission to use this command!", usage = "/<command>")
