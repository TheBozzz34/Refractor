...
@Permission(name = "refractor.dsc", desc = "Allows discord command", defaultValue = PermissionDefault.NOT_OP)
@org.bukkit.plugin.java.annotation.command.Command(name = "dsc", desc = "Sends a link to the Discord server",aliases = {"discord"}, permission = "refractor.dsc", permissionMessage = "You do not have permission to use this command!", usage = "/<command>")
