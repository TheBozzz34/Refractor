...
@org.bukkit.plugin.java.annotation.command.Command(name = "info", desc = "Information about the plugin", permission = "refractor.info", permissionMessage = "You do not have permission to use this command!", usage = "/<command>")
